...
// extern const uint8_t size_array;//размер массива. В нашем случае ширина 100
// точек(График 100*50 пикселей) extern uint8_t arr[100];//значения на графике.
// Заполняются в определенный момент времени(каждый шаг сдвига графика влево) extern bool
// array_is_full;//значения заполнили массив, можно сдвигать график влево
/*------------------------------Добавить в main.c-------------------------------*/
...
const char solderingiron[] = {
    0xC0, 0xE0, 0x30, 0x30, 0x30, 0x30, 0x60, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF8, 0xF8, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xF8, 0xF8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    };
/*-----------------------------Демонстрационное Logo----------------------------*/
...
/*------------------------Функция вывода изображения с указаием его
 * размера-------------------------*/
...
void GMG12864_Fill_the_array_Plot(uint8_t *counter, uint8_t *array, uint8_t size_array,
                                  uint8_t value)
{
    /// Функция, заполняющая массив значениями, чтоб отрисовывать график
    /// \param uint8_t *counter - счетчик значений
    /// \param uint8_t *array - массив, куда будем закидывать значения для отображения
    /// графика
    /// \param uint8_t size_array - размер массива, куда будем закидывать значения для
    /// отображения графика
    /// \param uint8_t value - подготовленное значение для графика(подготавливается при
    /// помощи ф-ии uint8_t GMG12864_Value_for_Plot(int y_min, int y_max, float value))
    if (*counter == 0)
    {
        array[0] = value;
    }
...
/*----------------------Функция, формирующая весь график, который будет отображаться на
 * дисплее-----------------------------*/
                               ...
                               uint8_t time_interval, bool grid)
{
    ...
    /// \param uint8_t *counter - счетчик значений
    /// \param uint8_t *array - массив, куда мы закидывали значения для отображения
    /// графика
    /// \param uint8_t size_array - размер массива, куда мы закидывали значения для
    /// отображения графика
    /// \param int y_min - минимальное значение по оси y
    /// \param int y_max - максимальное значение по оси y
    /// \param uint8_t x_grid_time - размер клетки по x(Например, график обновляется раз в
    /// 100 мс, значит одна клетка по X будет 1 сек.)
    ...
    if (array_is_full)
    {
        for (int i = 0; i < size_array - 1; i++)
        {
            ...
            GMG12864_Draw_line(127 - (i + 1), 50 - array[i + 1], 127 - i, 50 - array[i],
                               1); // Рисуем линиями
            // GMG12864_Draw_line(127-i, 50, 127-i, 50 - array[i], 1);//Закрашиваем
            // область
        }
    }
    else
                             ...
                             uint8_t color)
{
    ...
    GMG12864_Draw_line(x, y + height, x + width, y + height,
                       color);                      /*Низ прямоугольника*/
    GMG12864_Draw_line(x, y, x, y + height, color); /*Левая сторона прямоугольника*/
    GMG12864_Draw_line(x + width, y, x + width, y + height,
                       color); /*Правая сторона прямоугольника*/
}
/*--------------------------------Вывести пустотелый
 * прямоугольник---------------------------------*/
